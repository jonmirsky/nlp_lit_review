#!/usr/bin/env python3
"""
Filter RIS file to keep only references that match references in NBIB file.
...
- RIS file in the external OneDrive Endnote/intermediate_ris_files directory.

Outputs:
- In-place filtered RIS file in the external OneDrive Endnote/intermediate_ris_files directory.
- Backup file next to that RIS file with a .backup suffix.
"""
...
def main():
    ...
    ris_path = '/Users/jon/Library/CloudStorage/OneDrive-UniversityofMarylandSchoolofMedicine/NLP_lit_review/Endnote/intermediate_ris_files/pubmed_NLP_v4_12_17_25_1114am_neurocritical_filtered.ris'
