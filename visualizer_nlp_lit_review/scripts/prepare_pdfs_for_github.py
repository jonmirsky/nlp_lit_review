...
Inputs:
    External EndNote PDF folders in the OneDrive NLP_lit_review/Endnote directory.

Outputs:
    Flattened PDF copies in visualizer_nlp_lit_review/pdfs_for_github.
...
def main():
    ...
    output = visualizer_dir / "pdfs_for_github"
    ...
    flatten_pdfs(sources, str(output))
