...
Edit COMMON_SEARCH_TERMS to set query strings, RIS file prefixes, and (for batch refresh)
optional `slug` + `label` fields used by automated_search/scripts/refresh_catalog.py.
