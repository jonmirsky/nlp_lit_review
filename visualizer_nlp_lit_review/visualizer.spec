...
Inputs:
- Visualizer source, static, template, and RIS_source_files folders next to this spec file.
- Optional EndNote data folder either under this repository or in the external OneDrive NLP_lit_review/Endnote directory.

Outputs:
- PyInstaller build artifacts for the LiteratureReviewVisualizer executable.
"""
...
endnote_paths = [
    project_root.parent / 'Endnote' / 'from_zotero_v3.Data',  # Repository-level location
    project_root / 'Endnote' / 'from_zotero_v3.Data',  # Alternative location
    Path.home() / 'Library/CloudStorage/OneDrive-UniversityofMarylandSchoolofMedicine/NLP_lit_review/Endnote/from_zotero_v3.Data',
]
